            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" action="/select_password" class="pt-3" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input placeholder="username" id="username" type="text" class="form-control form-control-lg @error('username') is-invalid @enderror"
                   name="username" value="" autocomplete="name" autofocus>
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Phone" id="contact" type="tel" class="form-control form-control-lg @error('email') is-invalid @enderror"
                     name="contact" value=""  autocomplete="contact">
