          ...
          <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{$employee_user->contact_num}}
                      </td>
                      <td>
                        <a href="{{route('delete.user',['id'=>$employee_user->id])}}" 
                            onclick="event.preventDefault();
                                                                   document.getElementById('update-form').submit();"
                            class="dropdown-item"><i class="fas fa-trash-alt text-warning" style="font-size: 20px;"></i></a>
                                      <form id="update-form" action="{{route('delete.user',['username'=>$employee_user->username,'email'=>$employee_user->email])}}" method="POST">
                                        @csrf
                                        @method('delete')
                                      </form>
                      </td>
